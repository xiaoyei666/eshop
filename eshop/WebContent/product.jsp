  ...
  <tr> 
    ...
    <td width="25%" align="right" valign="top"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="4" class="commendbox">
        ...
        <tr> 
          <td colspan="2">共有${NUM_RATES}位顾客为本商品评分</td>
        </tr>
        <tr> 
          <td colspan="2">最高分：${HIGH_RATE}分</td>
        </tr>
        <tr> 
          <td colspan="2">最低分：${LOW_RATE}分</td>
        </tr>
        <!-- 如果NUM_RATES不等于0 -->
    ...
    <tr> 
      <td bgcolor="#FFCC66" height="22"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="50%">　
            <a href="default.asp" class="red">首页</a> &gt; <a href="category.jsp?" class="red" >${CategoryName}</a> &gt; <a href="subcategory.jsp?" class="red">${SubCategoryName}</a>
            </td>
            <td width="50%" valign="middle" align="center"> 
              <select name="mnuCategory">
                <option value="${CategoryID}" selected>在本类商城中</option>
